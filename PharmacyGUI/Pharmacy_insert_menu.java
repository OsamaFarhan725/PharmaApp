...
public class Pharmacy_insert_menu extends javax.swing.JFrame {

    public Pharmacy_insert_menu() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        insert_button.setText("Add Product");
    ...
    private void insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_buttonActionPerformed
        Pharmacy_queries.AddMedicine(name_field.getText(),type_field.getText(),Double.parseDouble(price_field.getText()), Pharmacy_sign_in.branch_id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pharmacy_insert_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pharmacy_insert_menu().setVisible(true);
            }
        });
    }
